...
- **Better caching** for AI responses
- **Offline embeddings** for semantic search
- **Incremental indexing** for large vaults
- **Multi-vault support**

### Potential Additions

- **Tauri** as Electron alternative (smaller bundle)
- **WebAssembly** for performance-critical code
- **Local vector database** for embeddings
- **P2P sync** for multi-device support
...
- [Contributing](https://github.com/virkillz/thinkpod) - Help improve ThinkPod
